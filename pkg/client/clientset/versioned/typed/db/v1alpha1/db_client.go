...
import (
	...
	"go.smartmachine.io/crdb-operator/pkg/client/clientset/versioned/scheme"
...
// DbV1alpha1Client is used to interact with features provided by the db.smartmachine.io group.
type DbV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DbV1alpha1Client) CockroachDBs(namespace string) CockroachDBInterface {
	return newCockroachDBs(c, namespace)
}
